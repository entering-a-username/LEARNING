(function () {
    ...
    names.forEach(function (name, index) {
        var thisPane = document.getElementById("pane-".concat(index + 1));
        var content = document.getElementById("contentID");
        var keys = Object.keys(people[0]).slice(1); // exclude the name property
        var _loop_1 = function (i) {
            var span = document.createElement("span");
            span.innerText = keys[i];
            thisPane === null || thisPane === void 0 ? void 0 : thisPane.appendChild(span);
            span.addEventListener("click", function () {
                content === null || content === void 0 ? void 0 : content.innerText = people[index][keys[i]];
            });
        };
        ...
        name.addEventListener("click", function () {
            thisPane === null || thisPane === void 0 ? void 0 : thisPane.classList.toggle("visible");
